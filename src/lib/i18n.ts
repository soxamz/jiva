...
const english = {
  ...
  "documents.shareWithDoctor": "Share with doctor",
  "documents.sharedWithDoctor": "Shared with doctor",
  "documents.privateToYou": "Private to you",
  "documents.noSharedWithDoctor":
    "The patient has not shared any documents with you.",
  ...
  "overview.weekDescription":
    "Overall summary from symptom checks and documents in the past 7 days.",
  "overview.windowDescription":
    "Overall summary from conversational intake and OCR documents in the past {count} days.",
  "overview.pastDays": "Past {count} days",
  "overview.range7": "Past 7 days",
  "overview.range30": "Past 30 days",
  "overview.range90": "Past 90 days",
  "overview.print": "Print",
  "overview.addNote": "Note",
  "overview.reportInaccuracy": "Report inaccuracy",
  ...
  "overview.weekEmptyTitle": "No activity in this period",
  "overview.weekEmptyDescription":
    "Complete a symptom check or upload a report from the last 7 days to build your clinical overview.",
  "overview.windowEmptyDescription":
    "Complete a symptom check or upload a report from the last {count} days to build your clinical overview.",
  "overview.summaryUnavailableTitle": "Summary not ready yet",
  "overview.summaryUnavailableDescription":
    "Past-week records were found, but Clinical Intelligence could not build a physician narrative. Try again after another symptom check.",
  ...
  "overview.vitalBp": "Blood pressure",
  "overview.vitalHr": "Heart rate",
  "overview.vitalWeight": "Weight",
  "overview.vitalSpo2": "SpO2",
  "overview.vitalElevated": "Elevated",
  "overview.vitalNormal": "Normal",
  "overview.vitalStable": "Stable",
  "overview.vitalNotRecorded": "Not recorded",
  "overview.recordSummaryTitle": "Care record summary",
  "overview.recordSummaryDescription":
    "Facts from records in the selected period.",
  "overview.symptomChecks": "Symptom checks",
  "overview.documentsReviewed": "Documents",
  "overview.urgentChecks": "Urgent checks",
  "overview.flaggedLabs": "Flagged lab results",
  "overview.latestCheck": "Latest symptom check",
  ...
  "overview.medReview": "Review recommended",
